...
cpp_fused_maximum_neg_0 = async_compile.cpp_pybinding(['const unsigned char*', 'const unsigned char*', 'unsigned char*'], '''
#include "/tmp/torchinductor_paperspace/wy/cwyvgno7oj63mpe36f4v6pizgeyvccmavffogp6xnqv56a32gbwo.h"
...
def call(args):
    ...
    buf0 = empty_strided_cpu((8390, 8), (8, 1), torch.uint8)
    cpp_fused_maximum_neg_0(arg1_1, arg0_1, buf0)
    del arg0_1
    del arg1_1
    return (buf0, )
